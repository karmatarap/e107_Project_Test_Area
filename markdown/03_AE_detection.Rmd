...
The area under curve is slightly below 90%. 
...
In order for the following code chunk to work, the [linked hack](https://groups.google.com/forum/embed/#!topic/rtexttools-help/Drqr3Z897Mk) has to be performed. Furthermore, we have to change the encoding to UTF-8.
...
We see that the results do not look terribly good...