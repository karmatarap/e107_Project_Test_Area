...
## Karma, please check if this makes any sense at all

Other interesting analyses could be similar to recommender systems: a recommender system can be thought of as a bipartitge graph. Then there is user-user collaborative filtering, i.e. we suggest new items based on preferences of similar users. In the case at hand, this would suggest new adverse events based on the ones a patient has. "Recommending an AE" in this case would correspond to suggesting diagnostic tests (in terms of graphs, this corresponds to link prediction).