...
If we want to predict ADRs on new drugs, our trained model should not have the drug name we are interested in included as feature. For the puropse of generating a new training sample, this could, however, be a good strategy, although one has to be careful with bias.
