...
In the following, we download tweets containing the drug names listed below. **We should add here when the actual data collection was performed**.
...
For being able to manually annotate some of the new tweets, we bring them in tabular form: we make them into a data frame having two columns:

+ tweet_id
+ tweet_text

Furthermore, we save a sample of 400 tweets as Ecel file in order to be able to manually annotate some of the tweets.
